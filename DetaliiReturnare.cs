...
{
    public partial class DetaliiReturnare : Form
    {
        public DetaliiReturnare()
        {
            InitializeComponent();
        }
        ...
        private void DetaliiReturnare_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from Eliberare where creturnare is not null";
